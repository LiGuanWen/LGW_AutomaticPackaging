...
target_name="LLAutomaticPackaging.xcworkspace" # 有效值 ****.xcodeproj / ****.xcworkspace (cocoapods项目)
project_name="LLAutomaticPackaging" # 工程名
work_type="workspace" # 有效值 project / workspace (cocoapods项目)
api_token="f066db8796674b4e04121f8808a2e123" # fir token
